...
<div class="row">
    <div class="col-sm-3">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Navigasi Pertanyaan</h3>
    ...
    <div class="col-sm-9">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><span class="badge bg-blue">Pertanyaan #<span id="soalke"></span> </span></h3>
                <div class="box-tools pull-right">
            ...
            <div class="box-footer text-center">
                ...
                <a class="ragu_ragu btn btn-primary" rel="1" onclick="return tidak_jawab();">Ragu-ragu</a>
