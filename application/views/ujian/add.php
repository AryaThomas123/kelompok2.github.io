        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    <h4>Matkul <i class="fa fa-book pull-right"></i></h4>
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <input placeholder="Jumlah Pertanyaan" type="number" class="form-control" name="jumlah_soal">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="jenis" class="form-control">
                        ...
                        <option value="Random">Pertanyaan Acak</option>
                        <option value="Sort">Pertanyaan Ber-Urut</option>
                    </select>
                    <small class="help-block"></small>
                </div>
