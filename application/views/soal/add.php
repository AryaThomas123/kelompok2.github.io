                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="form-group col-sm-12">
                            ...
                            <select name="dosen_id" required="required" id="dosen_id" class="select2 form-group" style="width:100% !important">
                                <option value="" disabled selected>Memilih Dosen</option>
                        ...
                        <div class="col-sm-12">
                            <label for="soal" class="control-label">Pertanyaan</label>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <select required="required" name="jawaban" id="jawaban" class="form-control select2" style="width:100%!important">
                                <option value="" disabled selected>Memilih Kunci Jawaban</option>
                        ...
                        <div class="form-group col-sm-12">
                            <label for="bobot" class="control-label">Bobot Pertanyaan</label>
