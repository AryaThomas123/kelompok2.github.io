<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body pb-0">
                <div class="form-group">
                    <label for="level">Tingkat Pengguna</label>
    ...
    <div class="col-sm-4">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body pb-0">
                ...
                <div class="form-group">
                    <label for="new_confirm">Konfirmasi Kata Sandi</label>
            ...
            <div class="box-footer">
                ...
                <button type="submit" id="btn-pass" class="btn btn-flat btn-primary">Ganti kata sandi</button>            
            </div>
        </div>
    </div>
    <?php endif; ?>
