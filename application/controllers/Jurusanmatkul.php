...
class JurusanMatkul extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'MataKuliah - Jurusan',
			'subjudul'=> 'Data MataKuliah - Jurusan'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Add MataKuliah - Jurusan',
			'subjudul'	=> 'Add MataKuliah - Jurusan. Data',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit MataKuliah - Jurusan.',
			'subjudul'		=> 'Edit Data MataKuliah - Jurusan.',
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('matkul_id', 'MataKuliah', 'required');
