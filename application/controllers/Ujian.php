...
class Ujian extends CI_Controller {
    ...
    public function akses_dosen()
    {
        if ( !$this->ion_auth->in_group('Lecturer') ){
			show_error('Halaman Ini Hanya Untuk Dosen Membuat Ujian Online, <a href="'.base_url('dashboard').'">Back to main menu</a>', 403, 'Forbidden Access');
		}
    }
    ...
    public function akses_mahasiswa()
    {
        if ( !$this->ion_auth->in_group('Student') ){
			show_error('Halaman Ini Hanya Untuk Mahasiswa Yang Ingin Mengikuti Ujian Online, <a href="'.base_url('dashboard').'">Back to main menu</a>', 403, 'Forbidden Access');
		}
    }
